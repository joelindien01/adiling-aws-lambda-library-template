...
import com.adiling.aws.framework.model.response.ErrorMessage;
import com.adiling.aws.framework.model.response.GatewayResponse;
...
public interface AdilingRequestStreamHandler extends RequestStreamHandler {
    int SC_OK = 200;
    int SC_CREATED = 201;
